/* TITLE hw4_3.cpp
 * ABSTRACT: c++ project1, this program is a virtual vending machine that can be added tp, reset, 
 * and can accept both credit and cash payment plus tax , can also make multiple machines
 * which can ......
 * Author: Kyle Dilbeck 
 * ID: 1996
 * Date: 2/21/19
...
string VendingMachine::displayMenu()
{
    ...
    cout << "  1. Water............$"<< setprecision(2) << fixed << water   <<endl
         << "  2. Regular Coffee...$"<< setprecision(2) << fixed << coffee  <<endl
         << "  3. Sun Chips........$"<< setprecision(2) << fixed << chips   <<endl
         << "  4. Chocolate Bar....$"<< setprecision(2) << fixed << chocBar <<endl;
    return end;
}
...
bool VendingMachine::payment()
{
    ...
    if(paymentOption == 1)
    {
        ...
        if(pin == PIN) //PIN == 7777
        {
            ...
            waterCount = waterCount = waterR;
            coffeeCount = coffeeCount - coffeeR;
            chipCount = chipCount - chipsR;
            chocBarCount = chocBarCount - chocoR;
            return true;
        }
        else
        {
    ...
    if(paymentOption == 2)
    {
        ...
        if(cashMoney > (totalPrice+taxx))
        {
            ...
            cout << "Change: " << setprecision(2) << fixed << change << endl; 
